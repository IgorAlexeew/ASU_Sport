...
export const data_table = {
    ...
    props: ['title', 'values', 'headers', 'select_data', 'update_url'],
    data() {
        return {
            copy: JSON.stringify(this.values),
            status: "editing"
        }
    },
    mounted() {
    ...
    methods: {
        ...
        submit() {
            ...
            axios
                .post(this["update_url"], this.values)
    ...
    template: `
      ...
      <div class="table-controls">
        ...
        <div v-if="this.status === 'loading'" class="status editing"><p>Загрузка...</p></div>
      ...
      <div class="lds-wrapper" v-else>
        <loader background="#000" style="margin: 0 auto" v-else></loader>
      </div>
    `
}