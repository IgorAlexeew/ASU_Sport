...
app.component("data-table", {
    ...
    methods: {
        ...
        submit() {
            ...
            axios
                .post("/api/section/update-sections", this.values)
    ...
    data() {
        return {
            ...
            headers: {
                ...
                name: { name: "Секция", type: "text" },
                sportObjectId: { name: "Спортивный объект", type: "select" },
                duration: { name: "Продолжительность, мин.", type: "number" },
            },
            sport_objects: {},
            select_data: {},
            update_url: "/api/section/update-sections"
        }
    },
    mounted() {
...
app.component("sections-table-page", {
    components: {
    ...
    template: `
        <div class="container">
            <data-table title="Секции" :select_data="this.$root.select_data" :values="this.$root.values" :headers="this.$root.headers" :update_url="this.$root.update_url"></data-table>
        </div>
    `
})
